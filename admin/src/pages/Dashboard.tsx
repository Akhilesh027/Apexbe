...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const res = await axios.get("http://api.apexbee.in/api/admin/dashboard/stats");
      setStats(res.data);
    } catch (error) {
  ...
  const fetchSalesData = async () => {
    try {
      const res = await axios.get("http://api.apexbee.in/api/admin/dashboard/sales");
  ...
  const fetchRecentActivity = async () => {
    try {
      const res = await axios.get("http://api.apexbee.in/api/admin/dashboard/recent-activity");
