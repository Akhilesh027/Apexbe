...
const Users = () => {
  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get("http://api.apexbee.in/api/admin/users");
  ...
  const changeUserRole = async (userId: string, newRole: string) => {
    try {
      await axios.put(`http://api.apexbee.in/api/admin/users/${userId}/role`, {
        role: newRole,
      });
  ...
  const toggleUserStatus = async (userId: string, currentStatus: string) => {
    ...
    try {
      await axios.put(`http://api.apexbee.in/api/admin/users/${userId}/status`, {
        status: newStatus,
      });
