...
const Addproduct = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      setLoading(true);
      try {
        const res = await axios.get(`http://api.apexbee.in/api/business/get-business/${vendorId}`);
  ...
  useEffect(() => {
    ...
    axios
      .get("http://api.apexbee.in/api/categories")
  ...
  const addNewSubcategory = async () => {
    ...
    try {
      const res = await axios.post(`http://api.apexbee.in/api/categories/${category}/subcategories`, {
        name: subName,
      });
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("http://api.apexbee.in/api/products/add-product", fd, {
