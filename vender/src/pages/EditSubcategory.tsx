...
const EditSubcategory = () => {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get("http://api.apexbee.in/api/categories");
  ...
  const fetchSubcategory = async () => {
    if (!id) return;
    try {
      const res = await axios.get(`http://api.apexbee.in/api/subcategories/${id}`);
      if (res.data.success) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.put(
        `http://api.apexbee.in/api/subcategories/${id}`,
        data,
